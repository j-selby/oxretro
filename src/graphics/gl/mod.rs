...
impl Renderer for GLRenderer {
    fn submit_frame(&mut self, frame: &[u8], width: usize, height: usize) {
        ...
        unsafe {
            ...
            self::gl::Uniform1i(
                self::gl::GetUniformLocation(self.program, b"tex\0".as_ptr() as *const _),
                0,
            );
            self::gl::TexParameteri(
                self::gl::TEXTURE_2D,
                self::gl::TEXTURE_WRAP_S,
                self::gl::CLAMP_TO_EDGE as self::gl::types::GLint,
            );
            self::gl::TexParameteri(
                self::gl::TEXTURE_2D,
            ...
            self::gl::TexParameteri(
                ...
                self::gl::NEAREST as self::gl::types::GLint,
            );
            self::gl::TexParameteri(
                self::gl::TEXTURE_2D,
            ...
            self::gl::TexImage2D(
                self::gl::TEXTURE_2D,
                0,
                self::gl::RGB as self::gl::types::GLint,
                width as i32,
                height as i32,
                0,
                self::gl::RGBA,
...
pub fn build(width: u32, height: u32) -> Box<Renderer> {
    ...
    unsafe {
        ...
        self::gl::VertexAttribPointer(
            pos_attrib as self::gl::types::GLuint,
            2,
            self::gl::FLOAT,
            0,
        ...
        self::gl::VertexAttribPointer(
            color_attrib as self::gl::types::GLuint,
            3,
            self::gl::FLOAT,
            0,
            7 * mem::size_of::<f32>() as self::gl::types::GLsizei,
        ...
        self::gl::VertexAttribPointer(
            tex_attrib as self::gl::types::GLuint,
            2,
            self::gl::FLOAT,
            0,
            7 * mem::size_of::<f32>() as self::gl::types::GLsizei,
